...
class tree{
  ...
  var $cut_size  = 60;
  // 許可するタグ（本文のみ）
  var $allow_tag = "<b><i><s><p><a><font>";
  // 禁止する文字（**に変換）
  var $bad_word  = "バカ|死ね|氏ね";
  // >引用がついた時の色
  var $quote	= "#aaaacc";
  ...
  var $root_msg = "<tr class=bgc><td align=center>{num}</td><td><a href={all}>{subj}</a></td><td align=center>{name}</td><td align=center>{res}</td><td><small>{ldate} <br>by {lname}</small></td></tr>\n";
  // タイトル表示フッタ
...
<p align=right><a href={reply}>返信する</a></p></td></tr></table>\n";
  ...
  // フッタ部分
  var $foot = "\n<hr size=1><map name="home">
  <area shape="rect" coords="20,19,327,73" href="http://www.d-planets.org/index.html" alt="HOME">
</map>
</body></html>";
...
//    $new_msg = "$no\t$oya\t$root\t$subj\t$name\t$email\t$date\t$com\t$url\t$tim\t$host\t$pwd\t$email_reply\n";
   ...
   */
  function show_foot(){
    $foot = str_replace("<map name="home">
  <area shape="rect" coords="20,19,327,73" href="http://www.d-planets.org/index.html" alt="HOME">
</map>
</body>","<map name="home">
  <area shape="rect" coords="20,19,327,73" href="http://www.d-planets.org/index.html" alt="HOME">
</map>
</body><p align=right><small><a href=http://php.s3.to>レッツPHP!</a></small>",$this->foot);//消すな
    return $foot;
  }
  /***
   * ツリー構造配列取得
