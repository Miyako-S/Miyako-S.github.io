...
<xsl:text disable-output-escaping="yes">"; str.replace("&#39;","’");</xsl:text>
    ...
    <xsl:text disable-output-escaping="yes">document.write('&lt;table border=&quot;0&quot;&gt;&lt;tr&gt;&lt;td bgcolor=&quot;hotpink&quot;&gt;&lt;b&gt;D&lt;/b&gt;een&lt;br /&gt;&lt;b&gt;L&lt;/b&gt;atest&lt;br /&gt;&lt;b&gt;D&lt;/b&gt;isc&lt;/td&gt;&lt;td&gt;</xsl:text>
    <xsl:element name="a">
    ...
    <xsl:text disable-output-escaping="yes">&lt;/td&gt;&lt;td&gt;')
    </xsl:text>
    
    <xsl:text disable-output-escaping="yes">document.write('</xsl:text>
    <xsl:element name="a"><xsl:attribute name="href">http://www.d-planets.org/release/s_32.html</xsl:attribute>' + str + ' →Discographyへ</xsl:element>
    ...
    <xsl:text disable-output-escaping="yes">document.write('</xsl:text>
	<xsl:text disable-output-escaping="yes">「DEEN The Best キセキ」収録の「TWELVE」に続き、織田哲郎が書き下ろしたバラード曲。シングルとしては約10年振りの書下ろしとなる。「このまま君だけを奪い去りたい」「翼を広げて」を彷彿とさせるナンバーとなっています。また、かつてライブで披露し好評だった「君がいない夏」のアコースティックバージョンも収録。</xsl:text>
